...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ptCV = findViewById(R.id.ptCardView);

        ptCV.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void ptAcitvity(){
        Intent intent = new Intent(MainActivity.this, PublicTransportMainActivity.class);
        try {
